...
$user->registerChefDepartemet($data);
    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Chef de Departement a été enregistré avec succès.
            </div>
...
<div class="mt-2 text-primary  ">
    ...
    <span class="h6 text-primary ">Ajouter Un Chef De Departement</span>
</div>
